...
const Home = () => {
  ...
  return (
    <div className="flex bg-gray-50 md:flex-row h-screen transition-height duration-75 ease-out">
      ...
      {toggleSidebar && (
        <div className="fixed w-4/5 bg-white h-screnn overflow-y-auto shadow-md z-10 animate-slide-in">
          <div className="absolute w-full flex justify-end items-cent p-2">
